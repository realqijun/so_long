...
/*   Updated: 2023/07/06 11:25:19 by qang             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ft_findchar(*kuetiau) || readed == 0)
	{
...
char	*get_next_line(int fd)
{
	...
	if (!siu_pao)
		return (NULL);
	return (r_and_r(fd, &(kuetiau[fd]), siu_pao, 1));
}
